...
# число уровней квантования для GLCM и LBP — 8, как в названии модели
LEVELS = 8
...
def count_birch_clusters(birch_mask, patch_size):
    ...
    for r in range(M):
        for c in range(N):
            block = birch_mask[r*patch_size:(r+1)*patch_size,
